        ...
        <div class="lg:w-64 flex-shrink-0">
          <div class="bg-white rounded-lg shadow p-4">
            ...
            <nav class="space-y-1">
              ...
              <router-link to="/user-center/collections" class="flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-gray-100 rounded-md">
              ...
              <router-link to="/user-center/downloads" class="flex items-center px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-100 rounded-md">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex-1">
          <div class="bg-white rounded-lg shadow p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              <div v-for="template in collections" :key="template.id" class="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div class="p-4">
                  ...
                  <div class="flex items-center justify-between">
                    <span class="text-lg font-bold text-gray-900">¥{{ template.price }}</span>
                    <div class="flex space-x-2">
                      <button @click="removeFromCollection(template.id)" class="px-3 py-1 border border-gray-300 text-gray-700 rounded-md hover:bg-gray-50 transition-colors text-sm">
                        取消收藏
                      </button>
                      <router-link :to="`/template/${template.id}`" class="px-3 py-1 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors text-sm">
                        查看详情
                      </router-link>
                    </div>
                  </div>
            ...
            <div v-if="collections.length === 0" class="text-center py-12">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 text-gray-400 mx-auto" fill="currentColor" viewBox="0 0 24 24">
                <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" />
              </svg>
              <h3 class="mt-4 text-lg font-medium text-gray-900">暂无收藏</h3>
              <p class="mt-2 text-gray-500">您还没有收藏任何模板</p>
              <router-link
                to="/templates"
...
const collections = ref([
  {
    id: 1,
    name: 'AI文案生成工具',
    description: '基于大语言模型的文案生成工具，支持多种场景的文案创作',
    price: 99,
    category: 'AI 文案生成',
    sales: 1280
  },
  {
    id: 2,
    name: '智能客服系统',
    description: '基于AI的智能客服系统，支持自动回复和问题处理',
    price: 199,
    category: 'AI 客服',
    sales: 950
  },
  {
    id: 4,
    name: 'AI知识库',
    description: '基于向量数据库的智能知识库，支持自然语言查询',
    price: 299,
    category: '企业知识库',
    sales: 680
  }
...
<style scoped>
/* UserCollections component styles */
</style>